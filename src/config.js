export default {
  Astronaut: {
    ...
    colorBg: '#83D9C8',
    colorText: '#5C77AC',
    illustration: require('./images/Astronaut.png'),
  },
  'Ballon Lost': {
    ...
    colorBg: '#D5E9F6',
    colorText: '#4E43FA',
    illustration: require('./images/Balloon Lost.png'),
  },
  'Boat Leak': {
    ...
    colorBg: '#EFEDFA',
    colorText: '#684CFF',
    illustration: require('./images/Boat Leak.png'),
  },
  'Broken Clock': {
    ...
    colorBg: '#FFE4EA',
    colorText: '#709BFA',
    illustration: require('./images/Broken Clock.png'),
  },
  'Broken Mug': {
    title: 'This Page is Broken',
    description:
    ...
    colorBg: '#D5E9F6',
    colorText: '#2F8E89',
    illustration: require('./images/Broken Mug.png'),
  },
  'Burnt Toast': {
    title: 'This Page is Burnt to a Crisp',
    description:
    ...
    colorBg: '#FFF4BB',
    colorText: '#4376C0',
    illustration: require('./images/Burnt Toast.png'),
  },
  'Caution Tape': {
    title: 'Caution! This Page is Cordoned Off',
    description:
    ...
    colorBg: '#83D9C8',
    colorText: '#965418',
    illustration: require('./images/Caution Tape.png'),
  },
  'Dog Ate': {
    ...
    colorBg: '#FFE4EA',
    colorText: '#824B2F',
    illustration: require('./images/Dog Ate.png'),
  },
  Ghost: {
    ...
    colorBg: '#D5E9F6',
    colorText: '#5F749C',
    illustration: require('./images/Ghost.png'),
  },
  'Ice Cream Spill': {
    title: 'This Page is Melted in the Sun',
    description:
    ...
    colorBg: '#FFF4BB',
    colorText: '#E896ED',
    illustration: require('./images/Ice Cream Spill.png'),
  },
  'Kids Toy': {
    ...
    colorBg: '#D5E9F6',
    colorText: '#DF245D',
    illustration: require('./images/Kid_s Toy.png'),
  },
  'Loch Ness': {
    title: 'This Page is Not Real',
    description:
    ...
    colorBg: '#EFEDFA',
    colorText: '#092048',
    illustration: require('./images/Loch Ness.png'),
  },
  'Lost Keys': {
    ...
    colorBg: '#FFF4BB',
    colorText: '#226FAB',
    illustration: require('./images/Lost Keys.png'),
  },
  'Lost Tourist': {
  ...
  Ostrich: {
    ...
    colorBg: '#EFEDFA',
    colorText: '#9F6C66',
    illustration: require('./images/Ostrich.png'),
  },
  'Pizza Boz': {
    ...
    colorBg: '#83D9C8',
    colorText: '#386177',
    illustration: require('./images/Pizza Box.png'),
  },
  'Shoes Tied': {
    title: 'Oh no! We tripped up!',
    description:
    ...
    colorBg: '#FFF4BB',
    colorText: '#180AD8',
    illustration: require('./images/Shoes Tied.png'),
  },
  'Spilled Milk': {
    title: 'Don’t Cry Over Spilled Page',
    description:
    ...
    colorBg: '#FFE4EA',
    colorText: '#673164',
    illustration: require('./images/Spilled Milk.png'),
  },
  Trash: {
    title: 'This Page is in the Garbage',
    description:
    ...
    colorBg: '#FFE4EA',
    colorText: '#4C76EC',
    illustration: require('./images/Trash.png'),
  },
  'Confused Travolta': {
    ...
    colorBg: '#FFFFFF',
    colorText: '#2F495E',
    illustration: require('./images/Confused Travolta.png'),
    maxWidth: '45rem',
  },
}
